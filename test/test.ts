...
describe('module replace',()=> {
    ...
    beforeEach(() => {
      ...
      it('should get single user data',  (done: any)=>{
      ...
      it('should throw an error for unmatched id', (done: any)=> {
      ...
      it('should create new user', (done: any)=> {
    ...
    it('should update the user specific data', (done: any)=>{
    ...
    it('should return error for unmatched data', (done: any)=>{
        td.when(userModule.updateUser({
            name: 'fabio heuser',
            role: 'admin',
            id: 111
